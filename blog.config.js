...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '世男Sky', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '是谁来自山川湖海，却囿于昼夜、厨房与爱？', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://shinansky-shinanskys-projects.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,ShinanSky,个人博客,blog', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '唐ICP备1145141919810', // 备案号 闽ICP备XXXXXX
